...
namespace GameJam
{
    class BlueBloodCell:SpriteBase
    {
        int hitPoints = 3;
        ...
        public BlueBloodCell(Texture2D texture,Texture2D hitTexture,Texture2D spawnTexture, Texture2D missileTexture, Vector2 position):base(texture)
        {
            Position = position;
