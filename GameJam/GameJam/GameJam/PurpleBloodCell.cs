...
namespace GameJam
{
    class PurpleBloodCell:SpriteBase
    {
        int hitPoints = 3;
        ...
        int fireTimeMin = 2000;//3000;
        int fireTimeMax = 5000;//5000;
        int fireTime = 4000;//4000;
        int fireTimer = 0;
        ...
        public PurpleBloodCell(Texture2D texture,Texture2D hitTexture,Texture2D spawnTexture, Vector2 position):base(texture)
        {
            Position = position;
