...
namespace GameJam
{
    public abstract class SpriteBase
    {
        ...
        public SpriteBase(Texture2D tex)
        {
            ...
            _drawoffset = new Vector2(tex.Width / 2.0f, tex.Height / 2.0f);
            _speed = 2;
            _rotate = false;
            _rotateAngle = 0.0f;
            _scale = 1.0f;
        ...
        {
            batch.Draw(_texture, _position - _drawoffset*Scale, _rectangle, Color.White, 0, Vector2.Zero, _scale, SpriteEffects.None, layer);
        }
